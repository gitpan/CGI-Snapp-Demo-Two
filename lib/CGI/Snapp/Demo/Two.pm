...
sub build_form
{
	...
	return "<br /><form id='two_form'>This is run mode '$run_mode'.<br /><button id='submit'>Click to submit run mode '$next_mode'</button><input type='hidden' name='rm' id='rm' value='$next_mode' /></form>";
...
L<https://rt.cpan.org/Public/Dist/Display.html?Name=CGI::Snapp::Demo::Two>.

=head1 Author

L<CGI::Snapp::Demo::Two> was written by Ron Savage I<E<lt>ron@savage.net.auE<gt>> in 2012.
